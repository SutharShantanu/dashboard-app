...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (errorParam) {
      if (errorParam === "Callback") {
        setError(
          "Authentication failed: There was a problem during the sign-in callback."
        )
      } else if (
  ...
  return (
    <div className="flex min-h-svh bg-background">
      ...
      <div className="relative hidden items-center justify-center overflow-hidden bg-muted/30 p-12 lg:flex lg:w-1/2">
        ...
        <Card className="z-10 flex h-full max-h-[800px] w-full max-w-2xl flex-col items-center justify-center border-none bg-background/50 p-12 shadow-xl backdrop-blur-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
          <div className="animate-fade-in-up mb-12 w-full max-w-md">
            <UndrawLogin primaryColor="#6366f1" height="300px" />
          </div>
          <div className="animate-fade-in-up text-center delay-150">
            <h2 className="mb-4 text-3xl font-bold tracking-tight">
              Welcome to Aegis Portal
            </h2>
            <p className="mx-auto max-w-md text-lg text-muted-foreground">
              Access your personalized student dashboard, manage data
              efficiently, and connect seamlessly with Google Sheets.
            </p>
          </div>
        </Card>
      </div>
