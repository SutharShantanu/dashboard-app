...
function DataGridColumnHeaderInner<TData, TValue>({
  ...
  const headerLabelClassName = cn(
    "inline-flex h-full items-center gap-1.5 text-xs font-normal text-secondary-foreground/80 [&_svg]:size-3 [&_svg]:opacity-60",
    className
  )

  const headerButtonClassName = cn(
    "-ms-2 h-6 rounded-none px-2 font-normal text-secondary-foreground/80 hover:bg-secondary hover:text-foreground data-[state=open]:bg-secondary data-[state=open]:text-foreground",
    className
  )
