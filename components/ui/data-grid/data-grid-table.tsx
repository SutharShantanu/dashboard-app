...
function DataGridTableBase({ children }: { children: ReactNode }) {
  ...
  return (
    <table
      ...
      className={cn(
        "caption-bottom text-left align-middle text-xs font-normal text-foreground rtl:text-right",
  ...
  return (
    <tbody
      className={cn(
        ...
        props.tableLayout?.rowRounded && "[&_td:first-child]:rounded-e-none",
        props.tableLayout?.rowRounded && "[&_td:last-child]:rounded-e-none",
...
function DataGridTableLoader() {
  ...
  return (
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      <div className="flex items-center gap-2 rounded-none border bg-card px-4 py-2 text-xs leading-none font-medium text-muted-foreground">
